...
THEORY ListSeenInfoX IS
  ...
  Seen_List_Precondition(Machine(ClassMch),removeCoordination)==(cc: CAREER & pp: PROFESSOR & cc: dom(career) & pp: dom(members) & card(dom(coordination))>0 & card(dom(coordination))<=2);
